...
class _$_TaskState implements _TaskState {
  _$_TaskState({final List<Task> tasks = const [], this.isLoading = true})
      : _tasks = tasks;
  ...
  @override
  String toString() {
    return 'TaskState(tasks: $tasks, isLoading: $isLoading)';
  }
...
abstract class _TaskState implements TaskState {
  factory _TaskState({final List<Task> tasks, final bool isLoading}) =
      _$_TaskState;
